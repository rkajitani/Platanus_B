...
public:
	PairedDBG(): ScaffoldGraph(), heteroCoverage(0.0), tolerenceFactor(1.0), cutoffLengthFactor(0.0), contigPreviousParentNodeID(0), oppositeBubbleContigID(0), mode(0x1 | 0x2), numInputBubbleContig(0) {}
	...
	virtual void loadResultSeq(const long minSeqLength, const unsigned long long readLength, const bool trimFlag);
