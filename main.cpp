...
void Usage(void)
{
    cerr << "Usage: platanus_b Command [options]\n\nCommand: assemble, iterate, combine (solve_DBG, gap_close, divide, kmer_divide)" << endl;
}
...
{
    cerr << "platanus_b version: " << platanus::ConstParam::VERSION << endl;
}
...
int main(int argc, char **argv)
{
    ...
    if (argc > 1) {
        ...
        } else if (strcmp(argv[1], "kmer_divide") == 0) {
